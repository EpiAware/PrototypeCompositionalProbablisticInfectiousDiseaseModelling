...
Discretised serial interval plot

```{julia}
#| output: true
#| label: fig-disc-si
#| fig-cap: Serial interval discretized using double censored marginalisation.

plt = plot_discretized_gt()
save("discretised_gi.png", plt)
```
