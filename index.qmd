...
We demonstrate two observation models: a deterministic model with direct Poisson link via `TransformObservationModel`, and a stochastic model that adds time-varying ascertainment using `Ascertainment` with an AR(1) process.
