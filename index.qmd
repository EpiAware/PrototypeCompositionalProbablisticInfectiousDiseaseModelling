...
We build the observation model through **composition** of modular components reusing the negative binomial link observation model (`negbin`) from Example 1, and then layer additional modelling components on top.
