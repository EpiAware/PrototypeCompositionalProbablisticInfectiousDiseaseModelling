...
The stochastic formulation allows time-varying components to absorb noise from model mis-specification, potentially improving robustness when mechanistic models are approximations.
