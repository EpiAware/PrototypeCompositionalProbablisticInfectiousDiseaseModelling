...
function posterior_gens_for_plot(inference_results, n; epi_prob, fixed_cluster_factor)
...
We use all of the available data as training data.

```{julia}
italy_training_data = italy_data
```
