...
Composable models, where components can be reused across contexts and combined whilst maintaining statistical rigour, could address these issues.
When components have common formats, specialists can contribute their knowledge without understanding entire modelling frameworks.
This allows different data sources to be analysed together reliably, and for domain expertise to be included, whilst remaining flexible.
...
In practice, rigorous policy-relevant modelling is possible with current practice but often comes at the cost of the flexibility needed for cross-domain collaboration and timely evidence generation.
