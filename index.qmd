...
Further investigation of `Gen.jl` [@cusumanotowner2019gen] and Genify [@tan2021genify] is needed, as Gen's programmable inference capabilities and tools like `AutoGP.jl` [@saad2023sequential] may overcome some limitations of `Turing.jl` whilst Genify's metaprogramming bridge could ease adoption by allowing modellers to write familiar Julia code.
