...
This approach has practical benefits for an epidemiological modeller by creating automatic modifications to the full composed model when the modeller makes modifications, such as changes to a model subcomponent or the population stratification.
