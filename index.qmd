...
We supply a constructor method for this Bayesian network structure composing the defined submodels.
...
Where the `tspan` argument sets the time range for the generative model.

#### Training Data for Inference
...
#### Defining Sampler Configuration
