...
Another symbolic-numeric approach to defining dynamical systems, `ModelingToolkit.jl` [@modelingtoolkit2021] and `Catalyst.jl` [@loman2023catalyst] from the SciML ecosystem [@SciML], achieve performance improvements through automated parallelisation, sparsity detection, and equation simplification.
Models written with these methods are abstracted similarly to our proposed DSL, and can be extended, but not directly composed.
