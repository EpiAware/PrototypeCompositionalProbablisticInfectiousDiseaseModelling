...
Multi-model efforts combine outputs to improve robustness, but without shared components it is unclear whether differences reflect assumptions or implementation.
...
Whilst we might want a diversity of approaches to improve robustness of findings [@brooks-pollock21_modellingcoviduk], the lack of common approaches risks masking differences in model assumptions from differences in implementation, preventing attribution of different results to their underlying causes [@Brockhaus2023-bt].
...
Achieving rigour through careful model development can come at the cost of the flexibility needed for cross-domain collaboration and timely evidence.
