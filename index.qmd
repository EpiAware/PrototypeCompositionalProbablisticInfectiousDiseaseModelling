...
However, `Turing.jl` and Julia are well positioned for optimisation with new auto differentiation backends like Enzyme [@moses2020enzyme] and Mooncake [@dalle2025differentiationinterface], which could reduce computational costs in future implementations.
...
An advantage of the Julia ecosystem for a composable modelling tool built on top of a PPL is the access to the full features of a programming language.
