...
fig_arima = let
    ...
    ax_ar = Axis(fig[1, 1]; ylabel="Zₜ", title="AR(2)")
    ax_ma = Axis(fig[1, 2]; title="MA(1)")
    ax_arma = Axis(fig[2, 1]; ylabel="Zₜ", xlabel="Time", title="ARMA(2,1)")
    ax_arima = Axis(fig[2, 2]; xlabel="Time", title="ARIMA(2,1,1)")
