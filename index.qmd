...
```{julia}
#| label: fig-example1
#| fig-cap: Posterior predictive results for South Korea COVID-19 case data. Top panel shows observed daily cases (black dots) with posterior predictive median (purple line) and 95% credible intervals. Middle panel shows the estimated time-varying reproduction number Rt with 95% credible intervals. Bottom panel shows the discretised serial interval used in the Renewal model for Example 1.
#| output: true
