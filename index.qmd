...
and finally fix the random variables in the generative model using the sampled parameters and the `fix` function. We can then call it to get simulated oberservations for `y`.
