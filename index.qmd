...
For the CIS example above, if those analysing the primary data used models composed from submodels, they could publish intermediate and fully deidentified results that others could integrate into their modelling using Markov melding or related methods [@goudie2019markov].
