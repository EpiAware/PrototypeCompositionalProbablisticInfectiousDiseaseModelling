...
Another symbolic-numeric approach to defining dynamical systems, `ModelingToolkit.jl` and `Catalyst.jl` from the SciML ecosystem [@SciML], achieve performance improvements through automated parallelisation, sparsity detection, and equation simplification.
