...
We create training data by subsetting the Italy data to match the extended time window required to handle reporting delays:

```{julia}
italy_training_data = (
    y_t = italy_data.y_t[1:epinow2.tspan[2]],
    dates = italy_data.dates[1:epinow2.tspan[2]],
    )
```
