...
To work around these flexibility constraints, some analyses choose tochain multiple models together, fitting separate models sequentially and passing outputs to subsequent stages [@huisman2022;@epinow2].
