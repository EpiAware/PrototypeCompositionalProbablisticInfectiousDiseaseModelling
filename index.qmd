...
In code, we use `broadcast_weekly` for the piecewise constant process, `LatentDelay` for the delay convolutions, and `ascertainment_dayofweek` to wrap the observation model with temporal effects.
