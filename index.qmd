...
Note that we display a subslice of parameters for demonstration brevity.

#### Case Study 1: Predictive plotting

To assess the quality of the inference visually we can plot predictive quantiles for generated case data using parameters drawn from the posterior distribution, as well as 
...
plot_post_pred(training_data, inference_results; epi_prob = epi_prob, fixed_cluster_factor = fixed_cluster_factor)
