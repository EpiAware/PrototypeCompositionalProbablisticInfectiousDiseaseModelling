...
Our first case study is "On the derivation of the renewal equation from an age-dependent branching process" [@mishra2020covid], which estimates time-varying reproduction numbers from case data by combining the renewal equation with a negative binomial observation model.
...
The `EpiProblem` container is used to assemble these three components into a complete generative model.
