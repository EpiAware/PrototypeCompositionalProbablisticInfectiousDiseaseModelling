...
Data security constraints meant external modellers accessed only summarised prevalence estimates rather than underlying observations.
This created a cascade where estimates were treated as data: prevalence estimates became inputs for incidence [@abbott2022estimating] and reproduction number estimates [@mccabe2024inferring], which themselves informed policy analyses [@mccrone2022delta;@nyberg2022omicron;@davies21_associationcovidengland].
...
This would make it easier to fully propagate uncertainty [@goudie2019markov] and avoid implicit assumptions that lead to bias in current approaches.
