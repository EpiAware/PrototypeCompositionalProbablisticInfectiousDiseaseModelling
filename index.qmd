...
This approach has practical benefits for an epidemiological modeller, such as changes to a model subcomponent creating automatic modifications to the full composed model by abstracting away low level implementation.
