...
- Figure 2: 
  - **Panel A**: Discretised serial interval pmf
  - **Panel B**: Posterior predictive: Cases
  - **Panel C**: Posterior predictive: Rt

![Posterior predictive results for South Korea COVID-19 case data. Top panel shows observed daily cases (black dots) with posterior predictive median (purple line) and credible intervals. Bottom panel shows the estimated time-varying reproduction number Rt with uncertainty quantification.](examples/example1/fig2.png){#fig-example1-results}
