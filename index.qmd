...
Further flexibility in conditioning on submodels at the `Turing.jl` level would reduce the need to handle such cases in our DSL layer, enabling scenarios such as fixing the infection process to known values whilst inferring observation model parameters.
