...
A domain-specific language (DSL) is a programming language tailored to a specific application domain, here epidemiological modelling, that uses terminology and concepts familiar to domain experts rather than general programming constructs.
Though importantly we are not locked in to this choice as the DSL is agnostic of the backed used.
