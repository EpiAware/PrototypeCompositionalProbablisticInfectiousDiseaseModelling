...
# Example: Create executable ARIMA model using our composed structure
arima_turing_model = generate_latent(arima_model, 50)

# Sample from the model
arima_samples = [arima_turing_model() for _ in 1:100]
```
