...
Our approach enables "LEGO-like" model decisions through standardised interfaces.
...
Through three epidemiological case studies using the EpiAware package, we demonstrate how domain experts can contribute model components without requiring comprehensive understanding of the entire system.
We discuss alternative design approaches, evaluate the strengths and limitations of our compositional framework, and identify key areas for future development.
