...
Following *Chatzilena et al.*, we use log-normal and gamma priors for $\beta$ and $\gamma$, but we use a more informative prior `Beta(1, 99)` for the initial proportion infected to concentrate prior mass near small outbreak initiations.
