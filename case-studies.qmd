...
# Structural parameters for pairplot (exclude noise and trajectories, keep first 2 noise as examples)
structural_params = filter(param_names) do name
    ...
    return !is_latent_traj(name)
end
pairplot(epinow2_results.samples[structural_params])

# Noise parameters for trace plots
noise_params = filter(is_noise_param, param_names)
plot(epinow2_results.samples[noise_params])
```
