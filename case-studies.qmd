...
We compose both models using `EpiProblem`, swapping the observation model at the top level to compare modelling assumptions whilst keeping the infection process fixed.
We reuse the same `inference_method` defined in @sec-example1.
