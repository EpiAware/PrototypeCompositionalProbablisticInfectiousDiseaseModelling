...
All code and data for reproducing the analyses in this paper are available at: [https://github.com/EpiAware/CaseForComposableIDModels](https://github.com/EpiAware/CaseForComposableIDModels).
...
We instead use $\text{Gamma}(2, 0.125)$ which has a prior mean of 0.25, implying a mean 4-day infectious period appropriate for influenza, while ensuring the prior is bounded away from zero.
