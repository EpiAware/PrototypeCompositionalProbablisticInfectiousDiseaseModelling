...
fig_sir = let
    ...
    # Plot individual posterior trajectories (randomly sample to avoid autocorrelation)
    n_post_samples = min(n_samples, length(det_posterior_sols))
    det_indices = rand(1:length(det_posterior_sols), n_post_samples)
    stoch_indices = rand(1:length(stoch_posterior_sols), n_post_samples)
